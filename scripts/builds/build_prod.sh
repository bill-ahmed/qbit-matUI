...
# rm -rf "$default_build_path/$win_build"
# rm -rf "$default_build_path/$unix_build"
...
# cp -r -v "$default_build_path/$login_build" "$default_build_path/$win_build/public"
# cp -r -v "$default_build_path/$login_build" "$default_build_path/$unix_build/public"

# Step (6) -- Compress both builds into .zip
echo "Compressing builds..."
cd "$default_build_path"
